#!/bin/bash
# Switch Primary Slot (30001) to Llama 3.2 11B Instruct
# Deploy: scp ... sparkuser@<spark>:~/ai/scripts/serve/

set -e
MODEL_PATH="/home/sparkuser/ai/models/llama/llama-3.2-11b-instruct"
SERVED_NAME="llama-3.2-11b-instruct"
CONTAINER_NAME="sglang-llama32-11b"
PORT=30001
...
# Start Llama 3.2 11B on Primary
