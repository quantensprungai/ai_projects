...
|---------|-------------------|------------|------------------|
| 4C Windfarms + Design | 3606 Farms, 3606 Design | ja | Grid light optional |
...
Stage-A Backbone für Working Board + Partner-Drafts ist **da**: Farms, CAPEX, Events, Häfen/Natura light, ERA5, Akteure, VPI-Einsätze DE, Sim-Rollen-Pilot.  
...
3. **Grid / Export-Kabel Meta** (4C) — wo schon in POP, selten extra Sheet nötig  
4. **MaStR-Matches** ausweiten (heute ~33 accepted) + Unit-Felder anreichern  
5. **Turbinen-Spec-Katalog** an `imc_turbine_models` hängen (OEM, Rotor, …)  
6. **Vessel-Wetter final** — Katalog-Platzhalter → Marc-Override  

## Nicht jetzt

CAPEX-Forecasts, Voll-VPI (17k), GIS-Vollimport, Sim/LCA in der App, Decom-Steps aus 4C generieren.
