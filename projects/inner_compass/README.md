...
Pre-Launch. **Produktphasen 0–9 zu**, Track Tiefe (Anker: `cursor/roadmap.md`). Nächster Bau: Plan 10 umsetzen (`HandbookInput`, kein LLM). Details Engines/Content: `cursor/status.md` (nicht Chat-Einstieg).
