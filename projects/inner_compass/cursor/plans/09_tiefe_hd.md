...
Schicht 2 (Re-Extraktion aus `payload.interactions`) ist **Plan 10**. Schema kommt aus diesem Plan.
...
- **Quelle der Regeln:** [hd_structure_v0.json](../../system_structure/hd_structure_v0.json) (`has_strategy`, `belongs_to_center`, Channel→Gates). Evidence = Datei+Zeile, `review_status=approved`, `edge_scope=intra_system`.
