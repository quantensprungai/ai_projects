...
`generate_meta_nodes` nicht in Phase 4/5. Meta-Wörter nur hier notieren.
...
| Tagstamm | Day Master / 日主 | Die Art, wie du da bist — eine Rolle, zehn Färbungen |

## Begriffe für `love_partnership` (Phase 7)
