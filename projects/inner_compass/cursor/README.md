...
Eine App, die aus Geburtsdaten (Datum, Uhrzeit, Ort) das persönliche Profil aus mehreren Wissenssystemen gleichzeitig berechnet (Human Design, BaZi, westliche Astrologie, Maya Tzolkin u.a.) und dem User als einheitliche, navigierbare Landkarte präsentiert — organisiert entlang von 10 Lebensbereichen.
...
| **contracts.md** | Dimensions-Contract (15 Keys), Lebensbereiche (10), Payloads, Enums | Bei Schema/Pipeline-Arbeit |
...
- **Code-Repo:** `code/hd_saas_app/` (Makerkit Next.js + Supabase) — wird zu `code/inner_compass_app/`
...
- **10** Lebensbereiche (User-facing Navigation)
