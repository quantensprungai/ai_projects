...
> **Anker (2026-09-16):** Phasen und nächster Schnitt: `cursor/roadmap.md` (Track Tiefe, Plan 09). Diese Datei ist **Engine-/Content-Bestand**, kein Chat-Einstieg. Die Zeilen darunter (Stand 2026-09-02, „App Phase 4“) sind historische Content-Notizen, nicht der Produkt-Anker.
>
