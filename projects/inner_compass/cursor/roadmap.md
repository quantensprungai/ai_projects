...
| 9 Mechanik-Kanten HD | **offen, nächster Bau** | Familie 2 Schicht 1 + `condition`; Identität liest Tor/Kanal | [plans/09_tiefe_hd.md](plans/09_tiefe_hd.md) |
| 10 Facetten + Re-Extraktion | geplant | Gift/Shadow/Trap lesen; Schicht 2 aus Interactions | folgt 09 |
| 11 Formulierer v0 | geplant | einmal pro Chart, HD-Identität, DE aus Atomen | folgt 10 |
...
**Empfehlung:** Track Tiefe. Nächster Schnitt Plan 09, nicht Jiazi, nicht elf Seiten.

**Nächster Bau:** [plans/09_tiefe_hd.md](plans/09_tiefe_hd.md).
...
|---|---|---|---|
| 1 | Plan 09 ausführen | Track Tiefe; Matrix-Zelle HD × Mechanik-Kanten | Formulierer; 418 |
...
| 7 | ~~Trap/Gift DE~~ | **Phase 10** Facetten lesen | `extract_pattern_traps` Job |
