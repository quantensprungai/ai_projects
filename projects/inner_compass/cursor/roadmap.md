...
**Offenes (aus Phase 2):** Worker-Prompt nutzt alte 10 Domänen-Enums → `exchange_learning`/`transformation_renewal` ohne Payload-Tags. Angleichen vor Phase 6, kein Re-Synth. Schwelle inhaltlicher Kanten (≥3/≥30 %) in Review 2 prüfen.
