...
| **Pipeline & Content** | E2E-Pipeline, MinerU, LLM, Runbooks, K3-Kanon, Ontologie-Split | s5_runbook.md, **astro_natal_ingest_runbook.md**, **ziwei_natal_ingest_runbook.md**, **unlimited_ocr_spike_runbook.md**, **literature_canon_by_scope.md**, **ontology_policy.md**                                                                                                                                                                                                                                                                                                                                                                            |
| **Produkt & Vision**   | PRD, Entscheidungen, Ideen, Inspirationen, Agent-Oberfläche | prd_v3.md, decisions.md, ideas.md, inspirations.md, vision_and_story.md, **agent_surface_and_monetization.md** |
...
- **Astro-Natal Ingest + KARTE-Rad:** astro_natal_ingest_runbook.md
- **Ziwei-Natal Ingest + KARTE:** ziwei_natal_ingest_runbook.md
